...
def generate_iot_data():
    ...
    while True:
        device_id = f"Device_{random.randint(1000, 999999)}"
    ...
    if connection_status == "Connected":
        if device_type == "Heart Rate Monitor":
            ...
            critical_data["ecg_readings"] = [round(random.uniform(-1.0, 1.0), 2) for _ in range(10)]  # Simulated ECG
...
def generate_report(num_entries=25000):
